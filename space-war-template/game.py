...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, image, shield, value, damage):
        super().__init__()
...
def start_level():
    ...
    if player.level == 6:
        ...
        e1= Enemy(150, 100,enemyRed_img, 1, 10 )
        e2= Enemy(250, 100,enemyRed_img, 1, 10 )
        e3= Enemy(350, 100,enemyRed_img, 1, 10 )
        e4= Enemy(450, 100,enemyRed_img, 1, 10 )
        e5= Enemy(550, 100,enemyRed_img, 1, 10 )
        e6= Enemy(650, 100,enemyRed_img, 1, 10 )
        e7= Enemy(315, 100,enemyBlack_img, 3, 50 )
        e8= Enemy(150, 200,enemyBlack_img, 3, 50 )
        e9= Enemy(250, 200,enemyBlack_img, 3, 50 )
        e10= Enemy(350, 200,enemyBlack_img, 3, 50 )
        e11 =Enemy(450, 200,enemyBlack_img, 3, 50 )
        e12 =Enemy(550, 200,enemyBlack_img, 3, 50 )
        e13= Enemy(215, 200,enemyBlack_img, 3, 50 )
        e14= Enemy(315, 200,enemyBlack_img, 3, 50 )
        enemies = Fleet(e1,e2,e3,e4,e5,e6,e7,e8,e9,e10,e11,e12,e13,e14)
    if player.level == 7:
    
        e1= Enemy(150, 100,enemyBlack_img, 3, 50 )
        e2= Enemy(250, 100,enemyBlack_img, 3, 50 )
        e3= Enemy(350, 100,enemyBlack_img, 3, 50 )
        e4= Enemy(450, 100,enemyBlack_img, 3, 50 )
        e5= Enemy(550, 100,enemyBlack_img, 3, 50 )
        e6= Enemy(650, 100,enemyBlack_img, 3, 50 )
        e7= Enemy(315, 100,enemyBlack_img, 3, 50 )
        e8= Enemy(150, 200,enemyBlack_img, 4, 60 )
        e9= Enemy(250, 200,enemyBlack_img, 4, 60 )
        e10= Enemy(350, 200,enemyBlack_img, 4, 60 )
        e11 =Enemy(450, 200,enemyBlack_img, 4, 60 )
        e12 =Enemy(550, 200,enemyBlack_img, 4, 60 )
        e13= Enemy(650, 200,enemyBlack_img, 4, 60 )
        e14= Enemy(750, 200,enemyBlack_img, 4, 60 )
        enemies = Fleet(e1,e2,e3,e4,e5,e6,e7,e8,e9,e10,e11,e12,e13,e14)
    if player.level == 8:
       ...
       e1= Enemy(150, 100,enemyRed_img, 1, 10 )
        ...
        e6= Enemy(650, 100,enemyRed_img, 1, 10 )
        e7= Enemy(315, 100,enemyBlack_img, 3, 50 )
        e8= Enemy(50, 200,enemyBlack_img, 3, 50 )
        e9= Enemy(750, 200,enemyBlack_img, 3, 50 )
        e10= Enemy(650, 200,enemyBlack_img, 3, 50 )
        e11= Enemy(450, 200,enemyBlack_img, 3, 50 )
        e12= Enemy(550, 200,enemyBlack_img, 3, 50 )
        e13= Enemy(255, 200,enemyBlack_img, 3, 50 )
        e14= Enemy(355, 200,enemyBlack_img, 3, 50 )
        e15= Enemy(150, 300,enemyBlack_img, 4, 60 )
        e16= Enemy(250, 300,enemyBlack_img, 4, 60 )
        e17= Enemy(350, 300,enemyBlack_img, 4, 60 )
        e18= Enemy(450, 300,enemyBlack_img, 4, 60 )
        e19= Enemy(550, 300,enemyBlack_img, 4, 60 )
        e20= Enemy(650, 300,enemyBlack_img, 4, 60 )
        e21= Enemy(750, 300,enemyBlack_img, 4, 60 )
        enemies = Fleet(e1,e2,e3,e4,e5,e6,e7,e8,e9,e10,e11,e12,e13,e14,e15,e16,e17,e18,e19,e20,e21)
    ...
    if player.level == 10
        e7= Enemy(315, 100,enemyBlack_img, 10, 500 )
        enemies = Fleet(e1)
